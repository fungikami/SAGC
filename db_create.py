...
user1 = Usuario(username="admin", name="Administrador", surname="Administrador", password="admin", rols=admin)
user2 = Usuario(username="user", name="Usuario", surname="Usuario", password="user", rols=analista)
...
p1 = Productor(ci=12345678, name="Productor1", surname="Productor1", telephone="0212-1234567", phone="0212-1234567", tipo_productor=prod1, direction1="Direccion1", direction2="Direccion2")
p2 = Productor(ci=87654321, name="Productor2", surname="Productor2", telephone="0212-1234567", phone="0212-1234567", tipo_productor=prod2, direction1="Direccion1", direction2="Direccion2")
